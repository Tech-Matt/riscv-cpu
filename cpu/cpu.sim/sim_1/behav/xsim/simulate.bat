...
REM
REM Generated by Vivado on Fri Apr 26 11:48:26 +0200 2024
...
call xsim  instr_fetch_testbench_behav -key {Behavioral:sim_1:Functional:instr_fetch_testbench} -tclbatch instr_fetch_testbench.tcl -log simulate.log
