...
#
# Script generated by Vivado on Thu Sep 28 18:42:14 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : register_file.sh
...
#
# Usage        : register_file.sh
#                register_file.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                register_file.sh [-reset_run]
#                register_file.sh [-reset_log]
#                register_file.sh [-help]
#
...
# script info
echo -e "register_file.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./register_file.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot register_file xil_defaultlib.register_file xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim register_file -key {Behavioral:sim_1:Functional:register_file} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/techmatt01/tools/Xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb register_file.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./register_file.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: register_file.sh [-help]\n\
Usage: register_file.sh [-step]\n\
Usage: register_file.sh [-lib_map_path]\n\
Usage: register_file.sh [-reset_run]\n\
Usage: register_file.sh [-reset_log]\n\
Usage: register_file.sh [-keep_index]\n\
Usage: register_file.sh [-noclean_files]\n\n\
