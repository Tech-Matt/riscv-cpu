...
#                script (type 'register_file.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.register_file xil_defaultlib.glbl -o register_file_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./register_file_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/techmatt01/Desktop/riscv-cpu/cpu/cpu.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key register_file_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc register_file_simv.daidir vcs_lib c.obj)
